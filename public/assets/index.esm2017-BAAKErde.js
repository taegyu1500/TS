import{p as _e,C as ge,r as z,S as me,t as v,v as Re,x as we,y as be,z as Te,F as ye}from"./firebase-DMO3EB_U.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fe="storage";function vt(e,t,n){return e=v(e),kt(e,t,n)}function Lt(e){return e=v(e),Et(e)}function St(e,t){return e=v(e),It(e,t)}function Bt(e=be(),t){e=v(e);const s=Re(e,fe).getImmediate({identifier:t}),r=we("storage");return r&&Pt(s,...r),s}function Pt(e,t,n,s={}){Nt(e,t,n,s)}function Ct(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new q(n,s,r,t,me)}function Dt(){_e(new ge(fe,Ct,"PUBLIC").setMultipleInstances(!0)),z(G,Y,""),z(G,Y,"esm2017")}Dt();export{Lt as a,Bt as g,St as r,vt as u};
